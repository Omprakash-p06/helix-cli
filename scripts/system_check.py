...
def detect_cpu():
    ...
    if os_name == "Linux":
        ...
        # Windows often does not expose full ISA flags via WMIC. Apply safe
        # model-based feature defaults to avoid under-scoring modern CPUs.
        ...
        if "ryzen" in model_lower:
            ...
            # Conservative baseline for most supported Intel Core/Xeon systems.
